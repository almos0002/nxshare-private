...
// Display Routes Only
Route::get('/n/{slug}', [NxLeakController::class, 'display'])->name('displaynx')->withoutMiddleware('auth');
Route::get('/w/{slug}', [WallpaperController::class, 'display'])->name('displaywp')->withoutMiddleware('auth');
