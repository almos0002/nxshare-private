...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div class="group relative overflow-hidden rounded-xl bg-white p-5 shadow-md transition-all hover:shadow-lg dark:bg-surface-800">
            ...
            <div class="mt-5 flex items-center">
                <span class="inline-flex items-center text-green-600 dark:text-green-400">
                    <i class="ri-arrow-up-line mr-1"></i> 15%
                </span>
        ...
        <div class="group relative overflow-hidden rounded-xl bg-white p-5 shadow-md transition-all hover:shadow-lg dark:bg-surface-800">
            ...
            <div class="mt-5 flex items-center">
                <span class="inline-flex items-center text-green-600 dark:text-green-400">
                    <i class="ri-arrow-up-line mr-1"></i> 28%
                </span>
                <span class="ml-2 text-surface-500 dark:text-surface-400">from last month</span>
            </div>
        ...
        <div class="group relative overflow-hidden rounded-xl bg-white p-5 shadow-md transition-all hover:shadow-lg dark:bg-surface-800">
            ...
            <div class="mt-5 flex items-center">
                <span class="inline-flex items-center text-green-600 dark:text-green-400">
                    <i class="ri-arrow-up-line mr-1"></i> 10%
                </span>
        ...
        <div class="w-full sm:w-auto">
            <form action="{{ route('addvd') }}" method="GET" class="flex">
                <div class="relative w-full sm:w-80">
                    ...
                    <input type="text" id="searchInput" placeholder="Search videos..." name="search" value="{{ request('search') }}" 
    ...
    <div class="overflow-hidden rounded-xl bg-white shadow-sm dark:bg-surface-800">
        <div class="border-b border-surface-200 px-6 py-4 dark:border-surface-700 flex items-center justify-between">
            ...
            <span class="inline-flex items-center rounded-full bg-surface-100 px-2.5 py-1 text-xs font-medium text-surface-800 dark:bg-surface-700 dark:text-surface-300">
                {{ $posts->total() }} total
            </span>
        </div>
            ...
            <table class="w-full">
                <thead>
                    <tr class="bg-surface-50 dark:bg-surface-700/50 border-b border-surface-200 dark:border-surface-700">
                        ...
                        <th class="whitespace-nowrap px-4 py-3.5 text-center w-24 text-sm font-medium text-surface-500 dark:text-surface-400">Thumbnail</th>
                    ...
                    @if(count($posts))
                        ...
                        <tr class="hover:bg-surface-50 dark:hover:bg-surface-700/50 transition-colors">
                            ...
                            <td class="whitespace-nowrap px-4 py-3.5 text-center">
                                <img src="{{ $post->thumbnail }}" alt="thumbnail" class="h-12 w-20 object-cover rounded-md inline-block">
                            </td>
                            ...
                            <td class="whitespace-nowrap px-4 py-3.5">
                                <div class="flex items-center justify-center space-x-2">
                                    <a href="{{ route('displayvd', $post->slug) }}" class="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-violet-100 dark:bg-violet-900/30 text-violet-600 dark:text-violet-400 hover:bg-violet-200 dark:hover:bg-violet-800/50 transition-colors" title="View">
                                    ...
                                    <a href="{{ route('deletevd', $post->slug) }}" onclick="return confirm('Are you sure you want to delete this post?')" 
        ...
        <!-- Pagination -->
        <div class="px-4 py-3 flex items-center justify-between border-t border-surface-200 dark:border-surface-700 sm:px-6">
                ...
                <div class="px-6 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <form id="postForm" method="post" action="{{ route('createvd') }}">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label for="thumbnail" class="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-1">Thumbnail URL</label>
                                <input type="text" name="thumbnail" id="thumbnail" placeholder="Enter thumbnail link" required
                                       class="w-full rounded-lg bg-white dark:bg-surface-900 border border-surface-200 dark:border-surface-700 focus:border-red-500 focus:ring focus:ring-red-200 dark:focus:ring-red-800 dark:focus:border-red-500 py-2 px-3">
                            </div>
                        ...
                        <div class="mt-6 flex justify-end space-x-3">
                            <button type="button" onclick="createModal()" class="inline-flex items-center justify-center px-4 py-2 rounded-lg bg-surface-100 dark:bg-surface-700 text-surface-700 dark:text-surface-300 hover:bg-surface-200 dark:hover:bg-surface-600 font-medium transition-colors">
                                Cancel
                            </button>
                            <button type="submit" class="inline-flex items-center justify-center px-4 py-2 rounded-lg bg-red-600 hover:bg-red-700 text-white font-medium transition-colors">
                ...
                <div class="px-6 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <form id="updateForm" method="post" action="{{ route('updatevd') }}">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label for="oldthumbnail" class="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-1">Thumbnail URL</label>
                                <input type="text" name="thumbnail" id="oldthumbnail" placeholder="Enter thumbnail link" required
                                       class="w-full rounded-lg bg-white dark:bg-surface-900 border border-surface-200 dark:border-surface-700 focus:border-red-500 focus:ring focus:ring-red-200 dark:focus:ring-red-800 dark:focus:border-red-500 py-2 px-3">
                            </div>
                        ...
                        <div class="mt-6 flex justify-end space-x-3">
                            <button type="button" onclick="updateModal()" class="inline-flex items-center justify-center px-4 py-2 rounded-lg bg-surface-100 dark:bg-surface-700 text-surface-700 dark:text-surface-300 hover:bg-surface-200 dark:hover:bg-surface-600 font-medium transition-colors">
                                Cancel
                            </button>
                            <button type="submit" class="inline-flex items-center justify-center px-4 py-2 rounded-lg bg-red-600 hover:bg-red-700 text-white font-medium transition-colors">
                                <i class="ri-save-line mr-1"></i>
