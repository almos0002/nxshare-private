...
@section('content')
        ...
        <div style="display:flex; justify-content:space-between;">         
            <form class="topbar-search" style="width:250px;" action="{{ route('addnx') }}" method="GET">
        ...
        <button class="btn btn-primary" onclick="createModal()">Add Post</button>
        </div>
        ...
        <div id="updatemodal" class="hidden">
            ...
            <div class="modal">
                <div class="modal-content">
                    <h3>Update Post</h3>
                    <br>
                    <form id="postForm" method="post" action="{{ route('updatenx') }}">
                        @csrf
                ...
                <tbody id="postTableBody">
                    ...
                    <tr class="post-item">
                        ...
                        <td style="display:flex;align-items:center;justify-content:center;">
                            <a href="{{ route('displaynx', $post->slug) }}" class="dropdown-notification-item-icon primary-soft" style="text-decoration:none;" ><i class="ri-eye-fill"></i></a>
                            ...
                            <a href="{{ route('deletenx', $post->slug) }}" class="dropdown-notification-item-icon danger-soft"  style="text-decoration:none; margin-right:0px !important;" onclick="return confirm('Are you sure you want to delete this post?')"><i class="ri-delete-bin-fill"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
