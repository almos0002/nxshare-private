...
<div class="space-y-8">
        ...
        <div class="relative px-6 py-8 md:px-8 md:py-10">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                <div class="mb-4 md:mb-0">
                    <h1 class="text-2xl font-bold">NXLeak Management</h1>
                    <p class="mt-1 text-red-100">Add, edit and manage your NXLeak collection</p>
                </div>
                <div>
    ...
    <div class="flex flex-col sm:flex-row justify-between gap-4 mb-6">
        <div class="w-full sm:w-auto">
            <form class="flex" action="{{ route('addnx') }}" method="GET">
    ...
    <div class="overflow-hidden rounded-xl bg-white shadow-sm dark:bg-surface-800">
        <div class="border-b border-surface-200 px-6 py-4 dark:border-surface-700 flex items-center justify-between">
            <h2 class="text-lg font-semibold text-surface-900 dark:text-white">NXLeak Posts</h2>
                        ...
                        <tr class="hover:bg-surface-50 dark:hover:bg-surface-700/50 transition-colors">
                            ...
                            <td class="whitespace-nowrap px-4 py-3.5">
                                <div class="flex items-center justify-center space-x-2">
                                    <a href="{{ route('displaynx', $post->slug) }}" class="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-violet-100 dark:bg-violet-900/30 text-violet-600 dark:text-violet-400 hover:bg-violet-200 dark:hover:bg-violet-800/50 transition-colors" title="View">
                                        <i class="ri-eye-fill"></i>
                                    </a>
                                    <button data-id="{{ $post->id }}" onclick="getPost('{{ $post->id }}')" 
                                    ...
                                    <a href="{{ route('deletenx', $post->slug) }}" onclick="return confirm('Are you sure you want to delete this post?')" 
    ...
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center">
        ...
        <div class="inline-block align-middle bg-white dark:bg-surface-800 rounded-xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-2xl sm:w-full">
            <div class="px-6 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <form id="postForm" method="post" action="{{ route('createnx') }}">
                    @csrf
                    <div class="space-y-4">
                        <div>
                        ...
                        <div>
                            <label for="content" class="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-1">Content</label>
                            <textarea id="content" name="content" placeholder="Enter content" required
                                      class="w-full rounded-lg bg-white dark:bg-surface-900 border border-surface-200 dark:border-surface-700 focus:border-red-500 focus:ring focus:ring-red-200 dark:focus:ring-red-800 dark:focus:border-red-500 py-2 px-3 h-48 resize-none">LINK
    ...
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center">
        ...
        <div class="inline-block align-middle bg-white dark:bg-surface-800 rounded-xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-2xl sm:w-full">
            <div class="px-6 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <form id="updateForm" method="post" action="{{ route('updatenx') }}">
                    @csrf
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label for="oldcontent" class="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-1">Content</label>
                            <textarea id="oldcontent" name="content" placeholder="Enter content" required
                                      class="w-full rounded-lg bg-white dark:bg-surface-900 border border-surface-200 dark:border-surface-700 focus:border-red-500 focus:ring focus:ring-red-200 dark:focus:ring-red-800 dark:focus:border-red-500 py-2 px-3 h-48 resize-none"></textarea>
                        </div>
                    </div>
