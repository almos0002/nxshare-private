                                ...
                                <tr class="hover:bg-surface-50 dark:hover:bg-surface-700/50 transition-colors">
                                    ...
                                    <td class="px-4 py-3.5 text-sm font-medium text-surface-900 dark:text-white">
                                        <div class="flex items-center">
                                            <div
                                                class="h-9 w-9 flex-shrink-0 rounded-md bg-red-100 dark:bg-red-900/30 flex items-center justify-center text-red-600 dark:text-red-400 mr-3 font-bold">
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3.5">
                                        <div class="flex items-center justify-center space-x-2">
                                            <a href="{{ route('displaynx', $post->slug) }}"
                                            ...
                                            <a href="{{ route('deletenx', $post->slug) }}"
                ...
                <div class="px-6 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <form id="postForm" method="post" action="{{ route('createnx') }}">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label for="content"
                                    class="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-1">Content</label>
...
@section('updatescript')
    <script>
        ...
        function copyPromotionalText(button) {
            ...
            const postUrl = `${window.location.origin}/n/${slug}`;
            const text = `⚡ ${title}⚡
