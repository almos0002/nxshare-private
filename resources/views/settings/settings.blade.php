        ...
        <div class="relative px-6 py-8 md:px-8 md:py-10">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                <div class="mb-4 md:mb-0">
                    ...
                    <p class="mt-1 text-brand-100">Manage your application preferences and configurations</p>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="mt-1">
                            <div class="flex items-center">
                                <label class="relative inline-flex cursor-pointer items-center">
                                    ...
                                    <span class="ml-3 text-sm font-medium text-surface-700 dark:text-surface-300">{{ old('redirect_enabled', $settings->redirect_enabled) ? 'Enabled' : 'Disabled' }}</span>
                                </label>
                            </div>
        ...
        <div class="overflow-hidden rounded-xl bg-white shadow-sm dark:bg-surface-800">
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <textarea name="ad1" id="ad1" rows="4" placeholder="Enter HTML or JavaScript code for ad section 1" class="block w-full rounded-md border-surface-300 py-2 text-surface-900 placeholder:text-surface-400 focus:border-brand-500 focus:ring-brand-500 dark:border-surface-600 dark:bg-surface-700 dark:text-white dark:placeholder:text-surface-500">{{ old('ad1', $settings->ad1) }}</textarea>
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <textarea name="ad2" id="ad2" rows="4" placeholder="Enter HTML or JavaScript code for ad section 2" class="block w-full rounded-md border-surface-300 py-2 text-surface-900 placeholder:text-surface-400 focus:border-brand-500 focus:ring-brand-500 dark:border-surface-600 dark:bg-surface-700 dark:text-white dark:placeholder:text-surface-500">{{ old('ad2', $settings->ad2) }}</textarea>
