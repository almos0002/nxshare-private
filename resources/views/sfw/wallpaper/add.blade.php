...
<div id="createmodal" class="hidden">
  ...
  <div class="modal">
    <div class="modal-content">
      <h3>Add New Post</h3>
      <br>
      <form id="postForm" method="post" action="{{ route('createwp') }}"> @csrf <div class="form-group">
...
<div id="updatemodal" class="hidden">
  ...
  <div class="modal">
    <div class="modal-content">
      <h3>Update Post</h3>
      <br>
      <form id="updateForm" method="post" action="{{ route('updatewp') }}"> @csrf <input type="hidden" id="postId" name="id">
      ...
      <tr>
        ...
        <td>
          <div style="display:flex;align-items:center;justify-content:center">
            ...
            <button class="dropdown-notification-item-icon success-soft" style="border: none; cursor: pointer;" data-id="{{ $post->id }}" data-title="{{ $post->title }}" data-links="{{ $post->links }}" onclick="populateUpdateModal(this)">
