...
<div class="space-y-8">
        ...
        <div class="relative px-6 py-8 md:px-8 md:py-10">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                <div class="mb-4 md:mb-0">
                    <h1 class="text-2xl font-bold">Wallpaper Management</h1>
                    <p class="mt-1 text-brand-100">Add, edit and manage your wallpaper collection</p>
                </div>
                <div>
                    <button onclick="createModal()" class="inline-flex items-center rounded-lg bg-white/10 px-4 py-2 text-sm font-medium text-white backdrop-blur-sm transition-colors hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-white/50">
    ...
    <div class="flex flex-col sm:flex-row justify-between gap-4 mb-6">
        <div class="w-full sm:w-auto">
            <form class="flex" action="{{ route('addwp') }}" method="GET">
                ...
                <button type="submit" class="ml-2 inline-flex items-center justify-center px-4 py-2 rounded-lg bg-brand-600 hover:bg-brand-700 text-white font-medium transition-colors">
    ...
    <div class="overflow-hidden rounded-xl bg-white shadow-sm dark:bg-surface-800">
        <div class="border-b border-surface-200 px-6 py-4 dark:border-surface-700 flex items-center justify-between">
            <h2 class="text-lg font-semibold text-surface-900 dark:text-white">Wallpaper Posts</h2>
            <span class="inline-flex items-center rounded-full bg-brand-50 px-2.5 py-0.5 text-xs font-medium text-brand-700 dark:bg-brand-900/30 dark:text-brand-400">
                {{ count($posts) }} posts
            </span>
        </div>
                        ...
                        <tr class="hover:bg-surface-50 dark:hover:bg-surface-700/50 transition-colors">
                            ...
                            <td class="px-4 py-3.5 text-sm font-medium text-surface-900 dark:text-white">
                                <div class="flex items-center">
                                    <div class="h-9 w-9 flex-shrink-0 rounded-md bg-brand-100 dark:bg-brand-900/30 flex items-center justify-center text-brand-600 dark:text-brand-400 mr-3 font-bold">
                            ...
                            <td class="whitespace-nowrap px-4 py-3.5">
                                <div class="flex items-center justify-center space-x-2">
                                    <a href="{{ route('displaywp', $post->slug) }}" class="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-brand-100 dark:bg-brand-900/30 text-brand-600 dark:text-brand-400 hover:bg-brand-200 dark:hover:bg-brand-800/50 transition-colors" title="View">
                                        <i class="ri-eye-fill"></i>
                                    </a>
                                    <button data-id="{{ $post->id }}" onclick="populateUpdateModal(this)" 
                                            class="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-amber-100 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400 hover:bg-amber-200 dark:hover:bg-amber-800/50 transition-colors" title="Edit">
                                        <i class="ri-edit-fill"></i>
                                    </button>
                                    <a href="{{ route('deletewp', $post->slug) }}" onclick="return confirm('Are you sure you want to delete this post?')" 
                                       class="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400 hover:bg-red-200 dark:hover:bg-red-800/50 transition-colors" title="Delete">
                        ...
                        <tr>
                            <td colspan="5" class="px-4 py-8 text-center text-sm text-surface-500 dark:text-surface-400">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-surface-500 dark:text-surface-400 text-sm mt-1">Start by adding a new wallpaper post</p>
                                </div>
                            </td>
                        </tr>
                    @endif
        ...
        <div class="border-t border-surface-200 bg-surface-50 px-6 py-4 dark:border-surface-700 dark:bg-surface-800/80">
            <div class="flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0">
                ...
                <div>
                    {{ $posts->appends(request()->except('page'))->links('pagination.tailwind') }}
                </div>
            </div>
        </div>
    </div>
