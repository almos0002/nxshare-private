@extends('layouts.app') @section('title', 'Profile Pictures') @section('content')
...
<div style="display:flex; justify-content:space-between;gap:8px;">
   <div>
      <form class="topbar-search" style="display: flex; gap: 5px;" action="{{ route('addpfp') }}" method="GET">
         ...
         <tr class="post-item">
            ...
            <td>
               <div style="display:flex;align-items:center;justify-content:center">
                  <a href="{{ route('displaypfp', $post->slug) }}" class="dropdown-notification-item-icon primary-soft" style="text-decoration:none;">
                  ...
                  <a href="{{ route('deletepfp', $post->slug) }}" class="dropdown-notification-item-icon danger-soft" style="text-decoration:none; margin-right:0px !important;" onclick="return confirm('Are you sure you want to delete this post?')">
