        ...
        <div class="relative px-6 py-8 md:px-8 md:py-10">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                ...
                <div class="flex space-x-2">
                    <a href="{{ route('dashboard') }}" class="inline-flex items-center rounded-lg bg-white/10 px-4 py-2 text-sm font-medium text-white backdrop-blur-sm transition-colors hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-white/50">
                        ...
                        <tr class="hover:bg-surface-50 dark:hover:bg-surface-700/50 transition-colors">
                            ...
                            <td class="whitespace-nowrap px-4 py-3.5">
                                <div class="flex items-center justify-center space-x-2">
                                    <a href="{{ route('displaypfp', $post->slug) }}" class="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-brand-100 dark:bg-brand-900/30 text-brand-600 dark:text-brand-400 hover:bg-brand-200 dark:hover:bg-brand-800/50 transition-colors" title="View">
                                    ...
                                    <a href="{{ route('deletepfp', $post->slug) }}" onclick="return confirm('Are you sure you want to delete this post?')" 
                        ...
                        <tr>
                            <td colspan="5" class="px-4 py-8 text-center text-sm text-surface-500 dark:text-surface-400">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-surface-500 dark:text-surface-400 text-sm mt-1">Start by adding a new profile picture post</p>
                                </div>
                            </td>
                        </tr>
                    @endif
