...
class WallpaperController extends Controller
{
    ...
    public function add(Request $request)
    {
        ...
        // Posts growth
        $currentMonthPosts = Wallpaper::whereMonth('created_at', $currentMonth)
            ->whereYear('created_at', $currentYear)
            ->count();
            
        $lastMonthPosts = Wallpaper::whereMonth('created_at', $lastMonth)
        ...
        $currentMonthViews = WallpaperView::whereMonth('created_at', $currentMonth)
            ->whereYear('created_at', $currentYear)
            ->count();
            
        $lastMonthViews = WallpaperView::whereMonth('created_at', $lastMonth)
            ->whereYear('created_at', $lastMonthYear)
            ->count();
        ...
        return view('sfw.wallpaper.add', compact(
    ...
    public function getLatestBatch()
    {
        ...
        $batchPosts = Wallpaper::where('title', 'like', 'Batch #%')->get();
